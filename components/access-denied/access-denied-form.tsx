...
interface AccessDeniedFormProps {
  email?: string
}

export function AccessDeniedForm({ email: prefillEmail }: AccessDeniedFormProps) {
    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div>
        ...
        <input
          ...
          className="w-full px-4 py-2.5 border border-slate-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent transition-all placeholder:text-slate-400"
        />
      </div>
      ...
      <div>
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2.5 border border-slate-300 rounded-lg text-sm text-slate-600 focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent transition-all placeholder:text-slate-400"
          />
        </div>
      </div>
      ...
      <Button
        ...
        className="w-full"
      >
        {loading ? 'Đang gửi...' : 'Đăng ký cấp quyền'}
      </Button>
