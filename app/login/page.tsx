      ...
      <div className="bg-white rounded-3xl shadow-2xl p-12 max-w-md w-full mx-4">
        ...
        <div className="text-center mb-8">
          <Link href="/" className="inline-block">
            <h1 className="text-4xl font-extrabold tracking-tighter bg-clip-text text-transparent bg-gradient-to-r from-teal-600 to-cyan-500">
              iPOS Kit
            </h1>
          </Link>
        ...
        <p className="text-center text-sm text-slate-400 mt-8">
          Chỉ nhân viên iPOS được phép truy cập
        </p>
      </div>
    </div>
  )
